    ...
    return (
        <div className="max-w-7xl mx-auto w-full min-h-[80vh] flex flex-col items-center justify-center gap-4">
            ...
            <Link
                reloadDocument
                to="/"
                className="text-gray-900 text-xl rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:underline"
            >
                go to home page
            </Link>
        </div>
